...
public class AmministratoreBean implements Serializable {
	...
	public AmministratoreBean(String codice_fiscale, String nome, String cognome, String username, String email,
			String password, int retribuzione_annuale) {
	...
	public String toString() {
		return "AmministratoreBean [codice_fiscale=" + codice_fiscale + ", nome=" + nome + ", cognome=" + cognome
